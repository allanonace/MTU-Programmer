#ifndef TIME_CONFIGURATION_SERVICE_CHAR_ON_TIMEOUT_H__
#define TIME_CONFIGURATION_SERVICE_CHAR_ON_TIMEOUT_H__
...
#define LEN_ON_TIMEOUT_CHAR	4

#define BLE_UUID_ON_TIMEOUT_CHAR					0x001e
...
#endif //TIME_CONFIGURATION_SERVICE_CHAR_ON_TIMEOUT_H__
